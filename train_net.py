...
"""
fewshotDiff fineturning Script.
modified by Sofachen 
changed by Alice
...
#my_voc_data_path = "datasets/VOC2012/"
# default configName : ("newdata_train",)
...
CLASS_NAMES = tuple(load_classNames())
...
def main(args): 
    ...
    if cfg.DATASETS.TRAIN == ('newdata_train',):
        register_pascal_voc("newdata_train", my_voc_data_path, "train", year=None,class_names=CLASS_NAMES)
        MetadataCatalog.get("newdata_train")
        DatasetCatalog.get("newdata_train")
